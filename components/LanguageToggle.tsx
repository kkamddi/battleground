...
const translations: Record<string, string> = {
  ...
  "최근 5경기는 왜 달라졌을까?": "Why did the last 5 matches change?",
  "상승세": "Improving",
  "하락세": "Declining",
  "유지 중": "Stable",
  "최근 경기에서는 킬 생산 증가가 상승세를 가장 크게 이끌었습니다.": "More kills were the biggest driver of the recent improvement.",
  "최근 경기에서는 킬 생산 감소가 흐름을 가장 크게 낮췄습니다.": "Fewer kills were the biggest drag on recent form.",
  "최근 경기에서는 교전 피해량 증가가 상승세를 가장 크게 이끌었습니다.": "Higher combat damage was the biggest driver of the recent improvement.",
  "최근 경기에서는 교전 피해량 감소가 흐름을 가장 크게 낮췄습니다.": "Lower combat damage was the biggest drag on recent form.",
  "최근 경기에서는 생존 시간 증가가 상승세를 가장 크게 이끌었습니다.": "Longer survival was the biggest driver of the recent improvement.",
  "최근 경기에서는 생존 시간 감소가 흐름을 가장 크게 낮췄습니다.": "Shorter survival was the biggest drag on recent form.",
  "최근 경기에서는 평균 순위 개선이 상승세를 가장 크게 이끌었습니다.": "Better placement was the biggest driver of the recent improvement.",
  "최근 경기에서는 평균 순위 하락이 흐름을 가장 크게 낮췄습니다.": "Worse placement was the biggest drag on recent form.",
  "이전 5경기 대비": "vs. previous 5",
  "내 맵 궁합": "My Map Fit",
  "2경기 이상 플레이한 맵 기준": "Maps played at least twice",
  "강한 맵": "Strong Map",
  "보완할 맵": "Map to Improve",
  "표본": "Sample",
  "평균 킬": "Average Kills",
  "평균 생존": "Average Survival",
  "평균 순위": "Average Placement",
  "자주 함께한 팀원과의 호흡": "Chemistry With Frequent Teammates",
  "최근 경기에서 2회 이상 같은 팀이 된 플레이어 기준": "Players who appeared on your team at least twice in recent matches",
  "찰떡 호흡": "Excellent Chemistry",
  "좋은 호흡": "Good Chemistry",
  "호흡 맞추는 중": "Building Chemistry",
  "함께한 경기": "Matches Together",
  "둘의 평균 킬": "Combined Average Kills",
  "팀원 ADR": "Teammate ADR",
  ...
  "플레이 리포트": "Play Report",
  "한눈에 보기": "At a Glance",
  "유형 · 진단 · 다음 경기": "Style · Diagnosis · Next Match",
  "내 플레이 유형": "My Play Style",
  "현재 진단": "Current Diagnosis",
  "다음 경기": "Next Match",
  "헤드샷 비중": "Headshot Rate",
  "평균 이동": "Average Movement",
  "상세 분석 보기": "View Detailed Analysis",
  "성장 · 맵 · 팀원 · 장비 · 최근 흐름": "Growth · Maps · Teammates · Gear · Recent Form",
